...
// Database Configuration - CUSTOMIZE THESE SETTINGS
// ================================================
$db_host = 'localhost';        // Database host
$db_username = 'root';          // Database username
$db_password = '';              // Database password
$db_name = 'sedga_registration'; // Database name
...
try {
    ...
    try {
        ...
        $sql = "INSERT INTO registrations (
                    first_name, last_name, email, phone_type, phone,
                    ...
                    total_amount, registration_date
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
        ...
        $stmt->bind_param(
            ...
            $firstName, $lastName, $email, $phoneType, $phone,
