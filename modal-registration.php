    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content modal-custom">
            ...
            <div class="modal-header bg-light border-bottom">
                ...
                <button type="button" class="btn-close ms-3" id="closeWizard" aria-label="Close" onclick="closeRegistrationWizard()"></button>
            </div>

            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title text-primary" id="registrationModalLabel">
                    <i class="fas fa-user-edit me-2"></i>Complete Your Registration
                </h5>
            </div>
                ...
                <div id="wizardStep1" class="wizard-step-content">
                    ...
                    <div class="col-lg-8">
                        <div class="card registration-card h-100">
                            ...
                            <div id="errorMessageContainer" class="alert alert-danger alert-dismissible fade" role="alert" style="display: none; margin: 15px 15px 0 15px; border-radius: 8px;">
                            ...
                            <div class="card-body">
                                <form id="registrationForm" novalidate>
                                    ...
                                    <div class="accordion" id="registrationAccordion">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <select class="form-select" id="phoneType" required>
                                                                ...
                                                                <option value="3">Video Relay Service (VRS)</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <select class="form-select" id="org_id" required>
                                                                ...
                                                                <option value="1">Alabama (ALDGA)</option>
                                                                <option value="2">Florida (FDGA)</option>
                                                                <option value="3">Georgia (GDGA)</option>
                                                                <option value="4">Kentucky (KDGA)</option>
                                                                <option value="5">Maryland (MDDGA)</option>
                                        ...
                                        <!-- GHIN Information Accordion Item -->
                                        <div class="accordion-item" id="ghinAccordionItem" style="display: none;">
                                            <h2 class="accordion-header" id="ghinInfoHeading">
                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#ghinInfoCollapse" aria-expanded="false" aria-controls="ghinInfoCollapse">
                                                    <i class="fas fa-id-card me-2 text-warning"></i>
                                                    <strong>GHIN Information</strong>
                                                    <span class="ms-2 text-muted">(For Handicap Tournament)</span>
                                                </button>
                                            </h2>
                                            <div id="ghinInfoCollapse" class="accordion-collapse collapse" aria-labelledby="ghinInfoHeading" data-bs-parent="#registrationAccordion">
                                                <div class="accordion-body">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="ghinNumber" class="form-label">
                                                                <i class="fas fa-id-card me-1"></i>GHIN Number *
                                                            </label>
                                                            <input type="text" class="form-control" id="ghinNumber" placeholder="Enter your GHIN number">
                                                            <div class="form-text">Required for Handicap Tournament participation</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <select class="form-select" id="emergencyPhoneType" required>
                                                                <option value="">Select Type</option>
                                                                <option value="1">Mobile</option>
                                                                <option value="2">Home</option>
                                                                <option value="3">Video Relay Service (VRS)</option>
                ...
                <div id="wizardStep2" class="wizard-step-content" style="display: none;">
                    <div class="alert alert-info d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <br>Make sure all details are correct before confirming your registration.
                        </div>
                    </div>
